...
Project X follows a modular, 3-layer architecture that separates script parsing, visual theme rendering, and UI state management.
...
1. **`InitializingScreen.tsx`**: Branded initial load screen displaying the Project X logo with subtle animation.
