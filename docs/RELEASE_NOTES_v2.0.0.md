...
- **Versioned JSON payload** — Exports produce a `projectx_presets_{tag}_{date}_{time}_{uniqueId}.json` file with version, timestamp, type tag, item count, and an array of preset objects.
...
See [CHANGELOG.md](./CHANGELOG.md) for the complete 42-commit breakdown, or view the [full diff on GitHub](https://github.com/mylife-as-miles/Project-X/compare/v1.0.0...v2.0.0).
