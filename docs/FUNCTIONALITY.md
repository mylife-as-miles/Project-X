...
Project X is a specialized tool for synchronizing video playback with a written script.
...
- **GUIDE (Quick Start)**: Every fresh installation or "Blank" project loads the Project X GUIDE—an interactive tutorial that explains formatting, staging, and cue management through narrative examples.
