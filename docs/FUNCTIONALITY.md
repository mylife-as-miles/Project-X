...
Project X is a specialized workspace for synchronizing video playback with written screenplays, evaluating AI video model fidelity, and analyzing script-to-screen prompt adherence.

---

## 1. Screenplay Parsing & Formatting Heuristics

Project X parses raw screenplay text into structured layouts using deterministic heuristics and regex:
