...
- **Comprehensive Documentation Refresh & Specification Synchronization**:
  ...
  - `docs/FUNCTIONALITY.md` — detailed dual script parsing heuristics (Screenplay & Auteur Script), updated staging scaffold specifications, and linked catalogue reference to `PROJECT_X_CATALOGUE.md`.
