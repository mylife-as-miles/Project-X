      ...
      lineCues.forEach(cue => {
        ...
        if (cue.start < lastIdx) {
          if (cue.end > lastIdx) {
            ...
            // In a Project X tool, overlapping cues on the same line are rare
          }
          return;
        }
    ...
    <div className="flex flex-col h-screen bg-stone-100 text-stone-900 font-sans overflow-hidden selection:bg-blue-100">
      ...
      <header className={cn(
        ...
        <div className="flex items-center gap-2 lg:gap-3">
          ...
          <div>
            <h1 className="text-sm lg:text-lg font-bold tracking-tight text-stone-900 leading-none">Project X</h1>
