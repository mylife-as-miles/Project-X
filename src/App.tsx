  ...
  if (!isInitialized) {
    return (
      <div className="h-screen w-full flex flex-col items-center justify-center bg-stone-100 gap-4">
        ...
        <p className="text-stone-500 font-mono text-sm animate-pulse">Initializing Project X...</p>
      </div>
    );
  }
      ...
      <header className={cn(
        ...
        <div className="flex items-center gap-2 lg:gap-3">
          ...
          <div className="hidden lg:block">
            <h1 className="text-sm lg:text-base xl:text-lg font-black tracking-tight text-stone-900 leading-none uppercase italic">Project X</h1>
